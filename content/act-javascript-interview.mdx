---
title: "Storing hierarical tree-like structures in MongoDB "
publishedAt: "2021-07-03"
summary: "Recently while building a Digital Asset Management (DAM) system at [Rocketium](https://rocketium.com), I was posed with a problem of building a hierarical structure to store files and folders where each folder may have more deeply nested folders containing files. Now, while this problem is simple to..."
